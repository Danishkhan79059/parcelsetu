...
export default function Footer() {
  ...
  const socials = [
    ...
    {
      label: 'Twitter/X', href: '#', color: '#000',
      icon: <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.742l7.73-8.835L1.254 2.25H8.08l4.253 5.622zm-1.161 17.52h1.833L7.084 4.126H5.117z" />,
    },
    {
      label: 'LinkedIn', href: 'https://www.linkedin.com/company/parcelsetu/', color: '#0A66C2',
  ...
  return (
    <footer style={{ fontFamily: "'Outfit','Segoe UI',sans-serif" }}>
      ...
      <div className="footer-bg">
        ...
        <div className="orb" style={{ width:500,height:500,background:'radial-gradient(circle,rgba(255,107,43,.06) 0%,transparent 70%)',top:-200,right:-150 }} />
        <div className="orb" style={{ width:400,height:400,background:'radial-gradient(circle,rgba(31,78,140,.1) 0%,transparent 70%)',bottom:-150,left:-100 }} />

        {/* Main content */}
        <div style={{ position:'relative',zIndex:1,padding:'52px 24px 44px' }}>
          <div className="footer-grid-cols">

            {/* ── Col 1: Brand ── */}
            <div>
              <div style={{ marginBottom:16 }}>
                <Image src="/images/company.jpeg" alt="ParcelSetu" width={130} height={45}
                  style={{ height:42,width:'auto',objectFit:'contain',borderRadius:8,filter:'brightness(1.05)' }} />
              </div>
              <p style={{ fontSize:13,color:'rgba(255,255,255,.5)',lineHeight:1.8,marginBottom:20,maxWidth:240 }}>
                Your trusted logistics partner connecting businesses across India
                with reliable transportation and fast delivery services.
              </p>

              {/* Trust pills */}
              <div style={{ display:'flex',flexDirection:'column',gap:8,marginBottom:24 }}>
                <div className="trust-pill"><div className="trust-dot" />500+ Cities Covered</div>
                <div className="trust-pill"><div className="trust-dot" />99% On-Time Delivery</div>
                <div className="trust-pill"><div className="trust-dot" />10K+ Happy Customers</div>
              </div>
              ...
              <div style={{ display:'flex',gap:8 }}>
                {socials.map(s => (
                  <a key={s.label} href={s.href} target={s.href.startsWith('http')?'_blank':'_self'}
                    ...
                    <svg style={{ width:15,height:15,fill:'white' }} viewBox="0 0 24 24">{s.icon}</svg>
                  </a>
                ))}
              </div>
            </div>
            ...
            <div>
              ...
              <div className="contact-chip">
                <div className="contact-chip-icon">
                  <svg style={{ width:14,height:14,fill:'white' }} viewBox="0 0 20 20">
                    <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"/>
                    <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"/>
                  </svg>
                </div>
                <div>
                  <div style={{ fontSize:10,color:'rgba(255,255,255,.35)',fontWeight:700,textTransform:'uppercase',letterSpacing:'.06em',marginBottom:3 }}>Email</div>
                  <a href="mailto:info@parcelsetu.com" className="">info@parcelsetu.com</a>
                </div>
              </div>
              ...
              <div className="contact-chip">
                ...
                <div>
                  <div style={{ fontSize:10,color:'rgba(255,255,255,.35)',fontWeight:700,textTransform:'uppercase',letterSpacing:'.06em',marginBottom:3 }}>Phone</div>
              ...
              <div className="contact-chip">
                ...
                <div>
                  <div style={{ fontSize:10,color:'rgba(255,255,255,.35)',fontWeight:700,textTransform:'uppercase',letterSpacing:'.06em',marginBottom:3 }}>Location</div>
                  <span>India</span>
                </div>
              </div>

              <div style={{ marginTop:20 }}>
                <a href="https://app.parcelsetu.com" target="_blank" className="portal-btn">
                  🔐 Portal Login
        ...
        <div className="footer-bottom">
          <div style={{ maxWidth:1200,margin:'0 auto',display:'flex',alignItems:'center',justifyContent:'space-between',flexWrap:'wrap',gap:12 }}>
            ...
            <div style={{ display:'flex',gap:20,alignItems:'center' }}>
              ...
              <span style={{ color:'rgba(255,255,255,.1)' }}>•</span>
              <Link href="#" className="bottom-link">Refund Policy</Link>
            </div>
          </div>
        </div>
      </div>
