      ...
      <section className="hero-bg py-32 relative">
        ...
        <div
          ...
          style={{
            ...
            height: 350,
            background:
              "radial-gradient(circle, rgba(31,78,140,0.35) 0%, transparent 70%)",
            bottom: -120,
            left: -60,
          }}
        ></div>
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          ...
          <p className="text-xl text-blue-200 max-w-2xl mx-auto leading-relaxed">
            Questions, partnerships, or urgent logistics support — our team is
          ...
          <div className="lg-grid" style={{ maxWidth: 1100, margin: "0 auto" }}>
            ...
            <div className="form-wrap">
              <div style={{ marginBottom: 28 }}>
                <div className="badge" style={{ margin: "0 0 12px" }}>
                  ✉️ Send a Message
                </div>
                <h2
                  style={{
              ...
              {submitted ? (
                ...
                >
                  ...
                  <p style={{ fontSize: 14, opacity: 0.9 }}>
                    Thank you for reaching out. Our team will respond to you
            ...
            <div className="info-wrap">
              ...
              >
                ...
                <p style={{ fontSize: 14, color: "#6B7280", lineHeight: 1.7 }}>
                  Whether you're a shipper needing transport, a carrier looking
                  to partner, or just have a quick question — our team is
                  standing by to provide fast, reliable support.
                </p>
              </div>
                ...
                {hours.map((h, i) => (
                  <div key={i} className="hours-row">
                    ...
                    >
                      <span
                        className="dot"
                        style={{ background: h.open ? "#10B981" : "#EF4444" }}
                      ></span>
                      {h.day}
                    </span>
                    <span
                      style={{
                        color: h.open ? "#1F4E8C" : "#EF4444",
                        fontWeight: 700,
                        fontSize: 13,
                      }}
                    >
              ...
              >
                ...
                <p style={{ fontSize: 13, color: "#A16207", lineHeight: 1.7 }}>
                  All enquiries are responded to within{" "}
                  <strong>2 business hours</strong>. For urgent shipments, call
          ...
          <div style={{ maxWidth: 900, margin: "0 auto" }}>
            <div className="emergency-card">
              ...
              >
                ...
                >
                  Critical shipment? Time-sensitive delivery? Our emergency team
                  responds immediately, 24 hours a day, 7 days a week.
                </p>
                ...
                >
                  <a
                    ...
                    className="emg-btn emg-btn-orange"
                  >
                    📞 Call Emergency Line
                  </a>
                  <a
                    href="mailto:emergency@parcelsetu.in"
                    className="emg-btn emg-btn-white"
                  >
                    📧 Email Emergency
                  </a>
                </div>
