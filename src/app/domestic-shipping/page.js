...
export default function DomesticShipping() {
  const serviceVariants = [
    ...
    },
    {
      ...
      points: [
        "Same-day & next-day where available",
        "Priority processing at hubs",
        "Great for premium customers",
      ],
      color: "#FF6B2B",
    },
    {
      ...
      points: [
        "Slot-based & on-demand delivery",
        "Ideal for food, grocery & pharma",
  ...
  const whyTrust = [
    {
      ...
      desc: "Strong coverage from metros to emerging towns so you can sell and deliver across India with confidence.",
      bg: "linear-gradient(135deg,#0F1C35,#1F4E8C)",
    },
    {
      emoji: "😊",
      title: "Customer Experience",
      desc: "Proactive communication, branded tracking and clear ETAs create a smoother experience for your end-customers.",
      bg: "linear-gradient(135deg,#FF6B2B,#e55a1c)",
    },
    {
      emoji: "🔗",
      title: "Flexible Integrations",
      desc: "Easy onboarding through APIs, shipment dashboards and simple order upload workflows tailored for your operations.",
  ...
  const shippingFlow = [
    {
      step: "01",
      title: "Create Order",
      text: "Upload or sync orders from your store, marketplace or ERP.",
      color: "#1F4E8C",
    },
    {
      step: "02",
      title: "Pickup & Sort",
      text: "We pick up parcels, sort them and allocate best routes.",
      color: "#FF6B2B",
    },
    {
      step: "03",
      title: "In Transit",
      text: "Shipments move through our network with live tracking.",
      color: "#A855F7",
    },
    {
      step: "04",
      title: "Out for Delivery",
      text: "Customers receive timely updates and on-time delivery.",
      color: "#10B981",
    },
  ];
    ...
    >
      ...
      <section className="hero-bg" style={{ padding: "90px 0 80px" }}>
        ...
        >
          ...
          >
            Reliable pan-India courier and parcel services for D2C, e-commerce
            and SMEs – from metros to Tier 2 &amp; Tier 3 cities, with real-time
          ...
          <div className="two-col">
            ...
            <div>
              ...
              <p style={{ fontSize: 15, color: "#6B7280", lineHeight: 1.9 }}>
                ...
                monitored with clear status updates so that you and your
                customers always know where the order is.
              </p>
            </div>
            {/* Right */}
            <div
            ...
            {serviceVariants.map((sv, i) => (
              <div key={i} className="sv-card">
                ...
                <div
                  className="sv-icon"
                  style={{
                    background: `rgba(${sv.color === "#1F4E8C" ? "31,78,140" : sv.color === "#FF6B2B" ? "255,107,43" : "16,185,129"},.08)`,
                  }}
                >
                  {sv.icon}
                </div>
      ...
      <section style={{ padding: "72px 24px", background: "white" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 52 }}>
            ...
            >
              Designed for D2C, marketplaces, SMEs and enterprises who want
              reliable domestic deliveries with strong post-purchase experience.
            </p>
      ...
      >
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 52 }}>
            ...
            >
              Simple Domestic{" "}
              <span style={{ color: "#FF6B2B" }}>Shipping Flow</span>
            </h2>
            <p
              style={{
                fontSize: 15,
            ...
            >
              From order creation to delivery, we keep the process transparent
              and easy to manage.
            </p>
            <div className="sdivider" />
          </div>
        ...
        <div style={{ maxWidth: 820, margin: "0 auto" }}>
          ...
          >
            ...
            <div style={{ position: "relative", zIndex: 1 }}>
              ...
              >
                Join thousands of D2C brands and SMEs who trust ParcelSetu for
